        ...
        topics: [
            {
                ...
                name: 'Login Issues',
                description:
                    'Problemas para iniciar sesión, restablecer contraseña u obtener acceso.',
                ticketCounts: 5,
            },
            {
                id: 'accountSettings',
                ...
                description:
                    'Preguntas sobre perfil, correo electrónico, y configuraciones de cuenta.',
                ticketCounts: 3,
            },
        ],
    },
    {
        ...
        topics: [
            ...
            },
            {
                ...
                name: 'Errors or Bugs',
                description:
                    'Reportes de errores o comportamientos inesperados.',
                ticketCounts: 9,
            },
        ],
    },
        ...
        topics: [
            {
                ...
                name: 'Performance',
                description:
                    'Lentitud, cuelgues u otros problemas de rendimiento.',
                ticketCounts: 4,
            },
            {
                id: 'security',
                name: 'Security',
                description:
                    'Problemas relacionados con permisos, accesos o seguridad.',
                ticketCounts: 6,
            },
            {
                id: 'integration',
                name: 'Integrations',
                description:
                    'Dificultades con sistemas externos o integraciones.',
                ticketCounts: 2,
            },
        ],
    },
...
export const helpListData = [
    {
        ...
        content:
            'Measuring programming progress by lines of code is like measuring aircraft building progress by weight. You can’t have great software without a great team, and most software teams behave like dysfunctional families.',
        topic: 'themes',
        createdBy: 'Ron Vargas',
        email: 'ron.vargas@mail.com',
        status: 'pending',
    ...
    },
    {
        ...
        content:
            'A hacker on a roll may be able to produce in a period of a few months something that a small development group (say, 7–8 people) would have a hard time getting together over a year. IBM used to report that certain programmers might be as much as 100 times as productive as others.',
        topic: 'themes',
        createdBy: 'Carolyn Hanson',
        email: 'carolyn.hanson@mail.com',
        status: 'pending',
    ...
    },
    {
        ...
        email: 'terrance.moreno@mail.com',
        status: 'pending',
        updateTime: '3 months ago',
        updateTimeStamp: 1711264064,
        replies: [],
