...
type PerkFormProps = {
    onFormSubmit: (values: PerkFormSchema) => void
    defaultValues?: PerkFormSchema
    newPerk?: boolean
} & CommonProps

const validationSchema: ZodType<PerkFormSchema> = z.object({
...
const PerkForm = (props: PerkFormProps) => {
    const {
        onFormSubmit,
        defaultValues = {},
        newPerk = false,
    ...
    const onSubmit = (values: PerkFormSchema) => {
        onFormSubmit?.(values)
    }
