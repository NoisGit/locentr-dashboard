...
const PerkInfoField = ({ title, value }: PerkInfoFieldProps) => {
    return (
        <div>
...
const ProfileSection = ({ data = {} }: ProfileSectionProps) => {
    ...
    const handleEdit = () => {
        navigate(`/concepts/perks/perks-edit/${data.id}`)
    }

    return (
        <Card className="w-full">
            <div className="flex justify-end">
                <Tooltip title="Edit perk">
                    <button
            ...
            <div className="flex flex-col xl:justify-between h-full 2xl:min-w-[360px] mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-1 gap-y-7 gap-x-4 mt-10">
                    <PerkInfoField title="Email" value={data.email} />
                    <PerkInfoField
                        title="Phone"
                ...
                >
                    <p>
                        Are you sure you want to delete this perk? All
                        records related to this perk will be deleted as well.
