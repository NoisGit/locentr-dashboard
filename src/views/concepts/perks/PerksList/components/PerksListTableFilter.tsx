...
const PerksListTableFilter = () => {
    const [dialogIsOpen, setIsOpen] = useState(false)

    const { filterData, setFilterData } = usePerksList()
    ...
    return (
        <>
            ...
            >
                <h4 className="mb-4">Filtrar perks</h4>
                <Form onSubmit={handleSubmit(onSubmit)}>
                    <FormItem label="Motivo del perk">
                        <Controller
                            name="motivo"
                            control={control}
                            render={({ field }) => (
...
export default PerksListTableFilter
