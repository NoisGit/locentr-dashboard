...
const AccessEdit = () => {
    ...
    const handleConfirmDelete = () => {
        ...
        toast.push(
            <Notification type="success">Access deleted!</Notification>,
            { placement: 'top-center' },
        )
        navigate('/concepts/accesses/access-list')
    }
        ...
        <>
            {!isLoading && !data && (
                <div className="h-full flex flex-col items-center justify-center">
                    ...
                    <h3 className="mt-8">No access found!</h3>
                </div>
            )}
            {!isLoading && data && (
                <>
                    <AccessForm
                        defaultValues={getDefaultValues() as AccessFormSchema}
                        newAccess={false}
                    ...
                    >
                        <p>
                            Are you sure you want to remove this access? This action can&apos;t be undone.
                        </p>
                    </ConfirmDialog>
                </>
            )}
