...
const AccessInfoField = ({ title, value }: AccessInfoFieldProps) => {
    return (
        <div>
        ...
        <Card className="w-full">
            ...
            <div className="flex flex-col xl:justify-between h-full 2xl:min-w-[360px] mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-1 gap-y-7 gap-x-4 mt-10">
                    <AccessInfoField title="Email" value={data.email} />
                    <AccessInfoField
                        title="Phone"
                ...
                >
                    <p>
                        Are you sure you want to delete this access? All
                        record related to this access will be deleted as well.
