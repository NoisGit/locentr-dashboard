...
const CondoInfoField = ({ title, value }: CondoInfoFieldProps) => {
    return (
        <div>
...
const ProfileSection = ({ data = {} }: ProfileSectionProps) => {
    ...
    const handleEdit = () => {
        navigate(`/concepts/condos/condos-edit/${data.id}`)
    }

    return (
        <Card className="w-full">
            <div className="flex justify-end">
                <Tooltip title="Edit condo">
                    <button
            ...
            <div className="flex flex-col xl:justify-between h-full 2xl:min-w-[360px] mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-1 gap-y-7 gap-x-4 mt-10">
                    <CondoInfoField title="Email" value={data.email} />
                    <CondoInfoField
                        title="Phone"
                ...
                >
                    <p>
                        Are you sure you want to delete this condo? All records related to this condo will be deleted as well. This action cannot be undone.
                    </p>
                </ConfirmDialog>
            </div>
        </Card>
