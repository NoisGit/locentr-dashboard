...
type WorkspacesFormProps = {
    mode?: 'create' | 'edit'
    submitLabel?: string
    submitting?: boolean
    defaultValues?: Partial<WorkspaceFormSchema>
    children?: ReactNode
    onFormSubmit: (values: WorkspaceFormSchema) => void
    onDiscard?: () => void
}
...
const WorkspacesForm = ({
    ...
    const finalSubmitLabel = submitLabel ?? (mode === 'edit' ? 'Guardar cambios' : 'Crear workspace')
